...
public class Balance extends javax.swing.JFrame {
    ...
    static int fees;
    public Balance(String name, String acc, int fees) {
        this.name=name;
        this.fees=fees;
        this.acc=acc;
        initComponents();
        try{
            ...
            ResultSet rs = s.executeQuery("select Phone,IFSC,Balance from customerstest1 where AccountNo='" + acc + "'");
            rs.next();
            jLabel9.setText(rs.getString(1));
            jLabel10.setText(rs.getString(2));
            jLabel11.setText(""+rs.getDouble(3));
        }
        catch(Exception e){
            e.printStackTrace();
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("BALANCE AND DETAILS");
